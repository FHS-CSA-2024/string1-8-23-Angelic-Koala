...
public class String1
{
    ...
    public String middleThree(String str) {
        int cut = (str.length() - 3) / 2;
        return str.substring(cut, str.length() - cut);
    }
    ...
    public String minCat(String a, String b) {
        ...
        int difference = longStr.length() - shortStr.length();
        return a.substring(a.length() - shortStr.length(),a.length()) + b.substring(b.length() - shortStr.length(),b.length());
    }
    ...
    public String deFront(String str) {    
        ...
        if(!first.equals("a")){
            ...
            str = first + str.substring(2, str.length());
        }
        return str;
    }
